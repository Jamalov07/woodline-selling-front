    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Ta'minotchi batafsil ma'lumotlari</p>
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid gap-4">
              ...
              {user.storehouse?.storehouse && (
                <div>
                  <Label className="text-sm font-medium">Bog'langan ombor</Label>
                  <p className="text-lg">{user.storehouse.storehouse.name}</p>
                </div>
              )}
              {user.storehouseId && (
                <div>
