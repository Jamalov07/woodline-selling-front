...
export default function SellersPage() {
  ...
  const [selectedRoles, setSelectedRoles] = useState<string[]>(["seller"])
  ...
  const handleViewDetails = (user: User) => {
    router.push(`/dashboard/users/sellers/${user.id}`)
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Sotuvchilar</h1>
          <p className="text-muted-foreground">Sotuvchilar ro'yxati va statistika</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Barcha sotuvchilar va ularning ma'lumotlari</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
              ...
              <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>Yangi sotuvchi ma'lumotlarini kiriting</DialogDescription>
                </DialogHeader>
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end space-x-2">
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              <AlertDialogTitle>Sotuvchini o'chirish</AlertDialogTitle>
                              <AlertDialogDescription>
                                Haqiqatdan ham "{user.fullname}" sotuvchisini o'chirmoqchimisiz? Bu amalni bekor qilib
                                bo'lmaydi.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Sotuvchi ma'lumotlarini yangilang</DialogDescription>
          </DialogHeader>
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-4">
            <div className="space-y-2">
